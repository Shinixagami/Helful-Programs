/*Name: Nichole Parkes
*Lab 6: Movie Linked Lists
*Editor used: notepad++
*Compiler: visual studio
*Description: Write a menu-driven program to keep track of your favorite movies
**************************************************************************************/
...
void bitchwork (Movies*& menu)
{
	...
	if (menu == nullptr)
	{
		...
		Movies* nextMovie ; //left side creates pointer. right side creates new structure


        nextMovie = new Movies();
