...
void outputTableBody (string courseName[], int courseYear[],  double courseUnits[], string courseGrade[], int N)
{
    ...
    for (int ND = 0; ND < N; ND++)
        ...
        cout << "Accessing data on array: [ " << ND << " ]" <<endl;  //test value
...
void CreateTxtFile (string courseName[], int courseYear[],  double courseUnits[], string courseGrade[], int N)  {
    ...
    cout << "Array Data Initialized up to Array [ " << N-1 << " ]" << endl; //TEST

    cout << "Total Arrays Initialized: " << N << endl; //TEST
       ...
       for (int ND = 0; ND < N; ND++) {
            ...
            cout << "Array data Name: " << courseName[ND] << endl;  //TEST

            cout << "Array data Year: " << courseYear[ND] << endl;  //TEST

            cout << "Array data Units: " << courseUnits[ND] << endl; //TEST

            cout << "Array data Grade: " << courseGrade[ND] << endl; //TEST
