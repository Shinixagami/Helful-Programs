...
Calculate function2(struct Calculate s); //DONE

//3. search expenses containing this string
void function3(struct Calculate s); // USE LOOP TO PRINT OUT.
//4. search expenses with greater than or equal to this amoun
...

{
 ...
 cout << "-------------------------" << endl;
    ...
    cout << "Value : " << setprecision(2) << fixed << .value << "  " << endl ;
