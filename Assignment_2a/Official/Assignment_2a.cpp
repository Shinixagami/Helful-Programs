...
int main () {
    ...
    if  (total >= 100 && deno >= 51) {
        ...
        cout << "return value or change: "<< ReturnValTotal << endl;
    ...
    if (total >= 50 && deno >= 21 && deno <= 50 ) {
         ...
         ReturnValDeno = CallDenomination(total, 50);

         ReturnValDeno += .099;;  //this one is the return value you get for other denos.
         ReturnValTotal =    ReturnValDeno;

         cout << "return value or change 50 next: "<< ReturnValTotal << endl;
