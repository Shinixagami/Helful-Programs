    ...
    if (fin.good()) // only read from the file if it exists!
        ...
        while (true || bufS != "EOF")
            ...
            */
            ...
            cout << "LAST NODE ADDRES tail: " << tail << endl;
...
void funcChoiceUpdate(CreateMovieNode*& head)
{
	...
	if(cVal != true)
    {
        ...
        cout << "Which movie do you want to update [1 -" << counter << "]: ";
        cin >> sequenceNumber;
...
cout << "~COUNTER IS NOW: " << counter << endl;
        ...
        while (true)
        {
            cout << "Enter the movie you would like to delete [please input the movie from list #1-" << counter << "]: ";
            cin >> sequenceNumber;

             if(nodeCount < sequenceNumber || sequenceNumber < 0)
            {
                cout << "Invalid Input try again. " << endl;
            }

            if(sequenceNumber > 0 && sequenceNumber <= nodeCount)
            {
                break;
            }
        ...
        if (sequenceNumber == 1)
        {
            ...
            cout << " (-) ------------------------------" << endl ;
            cout << "Movie #" << sequenceNumber << " deleted!" << endl;
            cout << "-----------------------------------" << endl ;
...
void enQueue (CreateMovieNode*& head, CreateMovieNode*& tail, CreateMovieNode* nodePtr)
{
	...
	else
	{
		...
		cout << " NOT FIRST - tail pointer: " << tail << endl;
	}
...
void CreateTxtFile (CreateMovieNode*& head, CreateMovieNode*& tail, int counter)
{
    ...
    fout.open("CreatefileFunction.txt");
