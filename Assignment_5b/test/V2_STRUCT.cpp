    ...
    while (true)
    {
        ...
        if(!buf.empty())  //If it is not empty
        {
            ...
            //input 3
             if (menuValue == 3)
            {
                function3(structArray, maxArraySize);
            ...
            //input 4
             if (menuValue == 4)
            {
                function4(structArray, maxArraySize);
...
void function1(Calculate* structArray, int arrayCounter)
{
    ...
    if(arrayCounter > 0)
    {
       cout << "Expenses: " << endl;
        ...
        {
            cout << "AMOUNT(" << setprecision(2) << fixed << structArray[i].desc << ") " ;
            cout << "DESC (" << structArray[i].cost << ")" << endl;
...
//    swap (s.counter, input.counter);
    ...
    cout << "AMOUNT(" << setprecision(2) << fixed << structArray[arrayCounter].desc << ") " ;
    cout << "DESC (" << structArray[arrayCounter].cost << ")" << endl;





    arrayCounter = arrayCounter +1; //moves array counter for new array.
...
//Array of Structs Expansion -------------------------------------------------
     ...
     if(arrayCounter == maxArraySize)
                    ...
                    for(int i=0; i < arrayCounter+1; i++)
                        ...
                        //deletes array with old data and releases storage
                        //remember NewArraySize now has the values
        ...
        for (int i = 0; i < arrayCounter+1 ; i++ )
        {
            ...
            cout << "AMOUNT(" << setprecision(2) << fixed << newArraySize[i].desc << ") " ;
            cout << "DESC (" << newArraySize[i].cost << ")" << endl;
...
void function3(Calculate* structArray, int arrayCounter)
{
    ...
    for (int n = 0; n < arrayCounter; n++ )
    {
        ...
        //stores decription for lower casing -must be lowercase for case insesitivity
        strcpy(tempDesc ,structArray[n].desc);

        cout << "Desc in Storage: " << tempDesc << endl;
        ...
        output = (tempDesc, cInput);


        cout << "OUTPIT: " << output << endl << endl;
