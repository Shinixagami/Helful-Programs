...
*       Uses array of structs and passes them to functions for input and search.
********************************************************************************/
int main ()
{
    //structArray is dynamic allowing us to create and change versions of structArray
    //Program uses array of structs. -Multiple Structs in an array.
    int maxArraySize = 2;
    Calculate *structArray = new Calculate[maxArraySize]; //dynamic array

	double arrayCounter = 0; //counts how many arrays are filled.
	int menuValue = 0;
...
void function3(Calculate* structArray, int arrayCounter)
{
    ...
    bool cVal = true; //for printing no search string
    ...
    for (int n = 0; n < arrayCounter; n++ )
    {
        ...
        if(output != NULL)
            ...
            cVal = false; //sets false once search is found
            }

    }//End of for loop

    //cVal is true by default -no search found
    if (cVal)
        {
...
void function4(Calculate *structArray, int arrayCounter)
{
    ...
    //Search Function ---------------------------
    bool cVal = true; //for printing no search matching ##
    for (int i = 0; i < arrayCounter; i++)
    {
